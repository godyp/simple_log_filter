...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand('simpleLogFilter.addColor', () => {
			provider.addColor();
		}));

	context.subscriptions.push(
		vscode.commands.registerCommand('simpleLogFilter.clearColors', () => {
...
class ColorsViewProvider implements vscode.WebviewViewProvider {
	...
	public static readonly viewType = 'simpleLogFilter.colorsView';
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		return `<!DOCTYPE html>
			...
			<body>
				...
				<button class="add-color-button">Add Filter</button>
